...
ifndef::backend-pdf[]
== Literals
See link:syntax/literals.adoc[here].
endif::[]
...
ifndef::backend-pdf[]
== Operators
See link:syntax/operators.adoc[here].
endif::[]
...
See link:syntax/functions.adoc[here].
endif::[]
...
ifndef::backend-pdf[]
== Branching
See link:syntax/branching.adoc[here].
endif::[]
...
ifndef::backend-pdf[]
== Loops
See link:syntax/loops.adoc[here].
endif::[]
...
ifndef::backend-pdf[]
== Error Handling
See link:syntax/error_handling.adoc[here].
endif::[]
...
ifndef::backend-pdf[]
== Shapes
See link:syntax/shapes.adoc[here].
endif::[]
...
ifndef::backend-pdf[]
== Namespaces
See link:syntax/namespaces.adoc[here].
endif::[]

// Units
ifdef::backend-pdf[]
include::syntax/units.adoc[leveloffset=+1]
endif::[]
ifndef::backend-pdf[]
== Units
See link:syntax/units.adoc[here].
endif::[]
...
ifndef::backend-pdf[]
== Im/Exporting
See link:syntax/im_export.adoc[here].
endif::[]
...
ifndef::backend-pdf[]
== Roles
See link:syntax/roles.adoc[here].
endif::[]
...
ifndef::backend-pdf[]
== Modules
See link:syntax/modules.adoc[here].
endif::[]
...
ifndef::backend-pdf[]
== Enum
See link:syntax/enum.adoc[here].
endif::[]
...
ifndef::backend-pdf[]
== Annotations
See link:syntax/annotations.adoc[here].
endif::[]
...
ifndef::backend-pdf[]
== Macros
See link:syntax/macros.adoc[here].
endif::[]
...
ifndef::backend-pdf[]
== References
See link:syntax/references.adoc[here].
endif::[]